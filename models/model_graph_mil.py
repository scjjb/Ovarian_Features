## Patch-GCN model from https://github.com/mahmoodlab/Patch-GCN
...
from models.model_clam import Attn_Net_Gated
...
class PatchGCN(torch.nn.Module):
    ...
    def forward(self,  data, label, instance_eval):
        ...
        ## adjustments to convert survival model into classifier:
        Y_prob = F.softmax(logits, dim = 1)
        #hazards = torch.sigmoid(logits)
        #S = torch.cumprod(1 - hazards, dim=1)

        return logits, Y_prob, Y_hat, A_path, None
