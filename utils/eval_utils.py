...
def initiate_model(args, ckpt_path, num_features=0):
    ...
    if args.model_type =='clam_sb':
        ...
        model = CLAM_MB(**model_dict)
         ...
         model = Graph_Model(pooling_factor=args.pooling_factor, pooling_layers=args.pooling_layers, embedding_size=args.embedding_size,num_features=num_features, num_classes=args.n_classes,drop_out=args.drop_out, message_passing=args.message_passing)
